 ...
 * </p>
 * <ul>
 *   <li>{@link org.xtext.example.mydsl.myDsl.impl.AddImpl#getChown_options <em>Chown options</em>}</li>
 *   <li>{@link org.xtext.example.mydsl.myDsl.impl.AddImpl#getFile <em>File</em>}</li>
 *   <li>{@link org.xtext.example.mydsl.myDsl.impl.AddImpl#getDirectory <em>Directory</em>}</li>
 * </ul>
 *
 * @generated
 */
public class AddImpl extends MinimalEObjectImpl.Container implements Add
{
  ...
  public void setChown_options(String newChown_options)
  {
    ...
    if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, MyDslPackage.ADD__CHOWN_OPTIONS, oldChown_options, chown_options));
  }
  ...
  public void setFile(String newFile)
  {
    ...
    file = newFile;
    if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, MyDslPackage.ADD__FILE, oldFile, file));
  }
  ...
  public void setDirectory(String newDirectory)
  {
    ...
    if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, MyDslPackage.ADD__DIRECTORY, oldDirectory, directory));
  }
  ...
  public Object eGet(int featureID, boolean resolve, boolean coreType)
  {
    switch (featureID)
    {
      case MyDslPackage.ADD__CHOWN_OPTIONS:
        return getChown_options();
      case MyDslPackage.ADD__FILE:
        return getFile();
      case MyDslPackage.ADD__DIRECTORY:
        return getDirectory();
    }
